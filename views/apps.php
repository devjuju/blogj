...
<ul class="list-group">
<li class="list-group-item-category d-flex justify-content-between align-items-center">
<h6 class="mb-2"><a class="liste-category-blog" href="index.php?action=posts">Tous</a></h6>

<span class="badge badge-counter rounded-pill">14</span>
</li>
<li class="list-group-item-category d-flex justify-content-between align-items-center">
<h6 class="mb-2"><a class="liste-category-blog" href="index.php?action=websites">Développement web</a></h6>
<span class="badge badge-counter rounded-pill">2</span>
</li>
<li class="list-group-item-category d-flex justify-content-between align-items-center">
<h6 class="mb-2"><a class="liste-category-blog active" href="#">
Développement d'applications</a></h6>
<span class="badge badge-counter rounded-pill active">1</span>
</li>
</ul>
